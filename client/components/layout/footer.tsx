      ...
      <div className="container mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 flex justify-center items-center">
        <div className="flex flex-wrap items-center justify-center gap-8">
          <Link
            ...
            className="flex items-center gap-1 text-sm border border-blue-200 bg-blue-50 text-blue-700 rounded-full px-2.5 py-0.5 transition-colors hover:bg-blue-100 hover:border-blue-300">
            <svg
